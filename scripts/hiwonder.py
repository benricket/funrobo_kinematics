...
from traj_gen_quintic import QuinticPolynomial, Trapezoidal
...
class FiveDOFRobot(FiveDOFRobotTemplate):
    ...
    def calc_numerical_ik(self, ee, joint_values, tol=0.01, ilimit=1000):
        # Numerical IK
        n = ilimit
        eps = tol
        attempts = 1000
...
if __name__ == "__main__":
    ...
    robot = RobotSim(robot_model=model,traj_model=traj_model)
